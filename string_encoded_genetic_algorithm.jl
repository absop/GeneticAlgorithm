...
function crossover!(genes)
    for i in 1:2:length(genes) - 1
        ...
        if rand() < pc
            ...
            ipart1 = i_xy_str[1:cross_pos]
            ipart2 = i_xy_str[cross_pos+1:lfc]
            jpart1 = j_xy_str[1:cross_pos]
            jpart2 = j_xy_str[cross_pos+1:lfc]
            str1 = string(ipart1, jpart2)
            str2 = string(jpart1, ipart2)
